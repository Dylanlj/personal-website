...
import palindromes  from '../assets/images/projects/palindromes.png'
import fruits       from '../assets/images/projects/fruits.png'
    ...
    return (
      <div className="content">
        <div className='project-content content-container'>
          <h2> PROJECTS </h2>
            <a href="https://array-of-fruits.herokuapp.com/">
              <img src={fruits} alt="fruits project"/>
              </a>
            <a href="https://array-of-palindrome.herokuapp.com/">
              <img src={palindromes} alt="palindromes project"/>
              </a>
